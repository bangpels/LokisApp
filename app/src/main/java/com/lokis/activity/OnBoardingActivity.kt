...
import com.lokis.R
import com.lokis.adapter.onBoardingViewPagerAdapter
import com.lokis.model.onBoardingData
...
class OnBoardingActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        onBoardingData.add(
            onBoardingData(
                getString(R.string.destinasi_wisata_disekitarmu), getString(
                    R.string.desc_one
                ),
        ...
        onBoardingData.add(
            onBoardingData(
                getString(R.string.title_two), getString(R.string.desc_two),
                R.drawable.asset_two
            )
        )
        onBoardingData.add(
            onBoardingData(
                getString(R.string.title_three), getString(R.string.desc_three),
