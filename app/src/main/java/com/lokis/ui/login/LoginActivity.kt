...
import com.lokis.R
import com.lokis.activity.ResetPasswordActivity
import com.lokis.databinding.ActivityLoginBinding
import com.lokis.ui.signup.RegisterActivity
...
class LoginActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val googleSignInOptions = GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN)
            .requestIdToken(getString(R.string.place_api))
            .requestEmail()
            .build()
    ...
    private fun firebaseAuthWithGoogleAccount(account: GoogleSignInAccount?) {
        ...
        auth.signInWithCredential(credential)
            .addOnCompleteListener(this){
                if (it.isSuccessful){
                    Intent(this@LoginActivity, com.lokis.MainActivity::class.java).also { intent ->
